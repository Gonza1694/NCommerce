...
{
    public class BancoServicio : ComprobanteServicio, IBancoServicio
    {
        ...
        public void Modificar(DtoBase dtoEntidad)
        {
            ...
            if (entidad == null) throw new Exception("Ocurrio un error al obtener el Banco");
        ...
        {
            Expression<Func<Dominio.Entidades.Banco, bool>> filtro =
