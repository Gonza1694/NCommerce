                ...
                c => new
                    {
                        ...
                        DepositoStockId = c.Long(nullable: false),
                        ...
                        CodigoBascula = c.String(nullable: false, maxLength: 4, unicode: false),
                        EsImpresionPorPrecio = c.Boolean(nullable: false),
                        EstaEliminado = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Deposito", t => t.DepositoStockId)
                .ForeignKey("dbo.Deposito", t => t.DepositoVentaId)
                .ForeignKey("dbo.ListaPrecio", t => t.ListaPrecioPorDefectoId)
                .ForeignKey("dbo.Localidad", t => t.LocalidadId)
                .Index(t => t.LocalidadId)
                .Index(t => t.DepositoStockId)
                .Index(t => t.DepositoVentaId)
