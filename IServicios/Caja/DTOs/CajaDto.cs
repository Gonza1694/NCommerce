...
namespace IServicios.Caja.DTOs
{
    public class CajaDto : DtoBase
    {
        ...
        public string FechaCierreStr => FechaCierre.HasValue ?
            FechaCierre.Value.ToShortDateString() : "----";

        public decimal? MontoCierre { get; set; }

        public string MontoCierreStr => MontoCierre.HasValue ?

            MontoCierre.Value.ToString("C") : "----";

        // ==========================================//
        public decimal TotalEntradaEfectivo { get; set; }

        public string TotalEntradaEfectivoStr => TotalEntradaEfectivo.ToString
